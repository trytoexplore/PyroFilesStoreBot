...
async def save_batch_media_in_channel(bot: Client, editable: Message, message_ids: list):
    try:
        ...
        share_link = f"https://t.me/{Config.BOT_USERNAME}?start=@LG_Bot_Updates_{str_to_b64(str(SaveMessage.message_id))}"
        await editable.edit(
            f"**Batch Files Has Been Stored in my Database Successfully!**\n\nHere is the Permanent Link of your files: {share_link} \n\n"
            f"Just Click the link to get your files! \n\n"Thanks For Using The Bot!!!",
            parse_mode="Markdown",
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("Open Link", url=share_link)],
                 [InlineKeyboardButton("Bots Channel", url="https://t.me/LG_Bot_Updates"),
...
async def save_media_in_channel(bot: Client, editable: Message, message: Message):
    try:
        ...
        share_link = f"https://t.me/{Config.BOT_USERNAME}?start=@LG_Bot_Updates_{str_to_b64(file_er_id)}"
        await editable.edit(
